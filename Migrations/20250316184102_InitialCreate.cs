    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FavoriteWorksheets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FavoriteWorksheets_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_FavoriteWorksheets_Worksheets_WorksheetId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Ratings_Worksheets_WorksheetId",
                        column: x => x.WorksheetId,
                        principalTable: "Worksheets",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FavoriteWorksheets_UserId",
                table: "FavoriteWorksheets",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_FavoriteWorksheets_WorksheetId",
                table: "FavoriteWorksheets",
                column: "WorksheetId");
